...
public class DigestActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(VrStrings.get(my.nicegram.vr.R.string.vr_digest_title));
    ...
    private void rebuild() {
        ...
        if (rows.isEmpty()) {
            ...
            infoText = VrStrings.get(my.nicegram.vr.R.string.vr_digest_empty);
        } else {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            final CharSequence name = VrNames.name(currentAccount, entry.dialogId,
                    VrStrings.get(my.nicegram.vr.R.string.vr_loading));
